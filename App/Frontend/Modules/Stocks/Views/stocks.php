...
<!-- SUBTITLES / FILTERS -->
<div id="navDot">
	<a href="#/"><button class="dot">DOT&nbsp;A</button></a>
	<a href="#/"><button class="dot">DOT&nbsp;G</button></a>
	<a href="#/"><button class="dot">DOT&nbsp;E</button></a>
	<a href="#/"><button class="dot">DOT&nbsp;Q</button></a>
	<a href="#/"><button class="dot">DOT&nbsp;T</button></a>
	<a href="#/"><button class="dot">DOT&nbsp;X</button></a>
	<a href="#/"><button class="dot">INGREDIENTS</button></a>
</div>
