<header>
	<a href="/projet-5-airfrance/Web/admin/" class="logoBackBlue"><i class="far fa-hand-point-left"></i></a><h1 class="titleComm">Team Communication</h1>
...
<section id="comSection">
	...
	<div id="communication">
		...
		<form id="createTopic" method="POST" action="/projet-5-airfrance/Web/admin/communication-newPost">
