<header>
	<a href="/projet-5-airfrance/Web/admin/" class="logoBackBlue"><i class="far fa-hand-point-left"></i></a>
	<h1 class="titleComm">On going communications</h1>
...
<section id="comSection">
	<aside>
		...
		<?php foreach ($postsOpen as $postOpen) : ?>
			<a href="/projet-5-airfrance/Web/admin/communication-onGoing-<?=$postOpen['id'] ?>">
		...
		<?php foreach ($postsClose as $postClose) : ?>
			<a href="/projet-5-airfrance/Web/admin/communication-archives-<?=$postClose['id'] ?>"><p class="postsClosed"><?= 'Title: '.$postClose['title']. "<br>". "By " . $postClose["author"] . " on " . $postClose["dateOpen"] ?></p></a>
		<?php endforeach ?>
	</aside>
		...
		<div id="titleComment">
			<?php foreach ($post as $post) : ?>
				...
				<p>
					...
					<a href="/projet-5-airfrance/Web/admin/communication-onGoing-<?=$post['id'] ?>-closeTopic">
